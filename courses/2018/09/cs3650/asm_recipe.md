...
```
  # if (x < y)
  mov -8(%rbp), %r10    # cmp can only take one indirect arg
  cmp %r10, -16(%rbp)
...
```
read_int:
  enter $8, $0  # Align stack & allocate 1 local
...
```
read_int:
  enter $8, $0   # Align stack & allocates an 8-byte (1-slot) stack frame
...
```
main:
  enter $24, $0     # Allocate stack frame with 3 slots (stack is aligned)
