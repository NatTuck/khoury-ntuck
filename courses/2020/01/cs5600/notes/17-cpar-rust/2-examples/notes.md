...
We can avoid data races by eliminating any one of those three things.

Eliminating more than one can have additional benefits.


## Plan A: Eliminate Paralleism

It's possible to have the appearance of concurrency without parallel execution,
using an event queue model.
...
## Plan D: Make Shared Data Immutable
