...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname interpreter-2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
; An Atom is one of:
;  - Symbol
;  - Number
;  - Boolean
...
; A Function is (make-func [List-of Symbol] [S-expr])
...
(define (apply1 fn args env)
  (local ((define our-env (add-args (func-params fn) args env)))
