...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname sexps) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ())))
...
(check-expect (replace1 '(1 2 3) 1 4) '(4 2 3))
(check-expect (replace1 '(blue 5) 'blue 5) '(5 5))
